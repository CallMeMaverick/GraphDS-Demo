...
const GraphComponent = () => {
    ...
    return (
        <div className={"flex flex-col justify-center self-center mt-4"}>
            <div className={"flex flex-row justify-around items-center mb-4 gap-12"}>
            ...
            <div id="d3-edit" className="relative flex justify-center items-center w-full h-full"></div>
        </div>
    );
};
